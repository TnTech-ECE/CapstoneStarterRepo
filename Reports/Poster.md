...
You may instead choose to use overleaf to make the poster. A template is included [here](Poster Template). Upload this template to overleaf and customize as necessary. The template is already the appropriate size.
