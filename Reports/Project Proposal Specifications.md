...
<head>
  ...
  <style>
    ...
    .planned { background-color: red; }
    .in-progress { background-color: yellow; }
    .completed { background-color: green; }
    .break { background-color: cyan; }
    .due { border: 2px solid black; }
    .legend td {
      text-align: left;
    }
  </style>
...
<body>
  ...
  <h3>Legend</h3>
  <table class="legend">
    <tr><td class="planned">&nbsp;&nbsp;&nbsp;</td><td>Planned</td></tr>
    <tr><td class="in-progress">&nbsp;&nbsp;&nbsp;</td><td>In Progress</td></tr>
    <tr><td class="completed">&nbsp;&nbsp;&nbsp;</td><td>Completed</td></tr>
    <tr><td class="break">&nbsp;&nbsp;&nbsp;</td><td>Break</td></tr>
    <tr><td class="due">&nbsp;&nbsp;&nbsp;</td><td>Due Date</td></tr>
  </table>
