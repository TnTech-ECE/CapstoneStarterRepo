...
| DetermingAngles | This function will determine the pointing angles for the motor servos. It will utilize the RID_data according to when the the values of the take_picture boolean and the    
