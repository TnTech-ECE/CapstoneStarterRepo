...
| Determine_SLM | This function will utilize the RID_data array to determine whether the UAS or control station is moving in straight line motion within a 5% error margin. If straight line motion is determine  | This function will only execute its calculations when the take_picture boolean is high |
| Predict_location | This function will utilize the | This function will only execute its calculations when the take_picture boolean is high and the predict_location boolean is high |
