...
| 3.  | The system shall be able to communicate effectively over a distance of 915 meters or 1 kilometer in order to scale over all of campus. This is the approximate distance from Brown Hall to the far edge of Purple Lot. This was determined to be the farthest point on campus from Brown Hall using Google Maps. This distance must be achieved even when the signal has to pass through several layers of material. | System Requirements |
...
3. The system shall be able to communicate effectively over a distance of 915 meters or 1 kilometer in order to scale over all of campus. This is the approximate distance from Brown Hall to the far edge of Purple Lot. This was determined to be the farthest point on campus from Brown Hall using Google Maps. This distance must be achieved even when the signal has to pass through several layers of material. Reliable communication is a requirement for the system to function as intended. The Ericsson Urban Propagation Model was used to estimate the range of the network in the addressing constraints section of this document. If testing is done at the parking lot behind Brown Hall, an approximate distance of 255 feet is all that is required, scalability to all of campus is the goal, however.
