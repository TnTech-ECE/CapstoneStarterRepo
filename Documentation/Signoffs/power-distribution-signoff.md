...
/// The narrowest trace is the other thing limiting current -> 0.5mm trace at SW pin, use 2 oz copper. Current limit of thinest trace, cite nec and nfpa stuff, calculate max current of thinist trace sourcing that current and choice of fuse to prevent trace failure due to overheating. Also cite fr4 max operable temp
