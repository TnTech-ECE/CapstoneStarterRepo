...
## Functionality
The functionality for the receiver power system is to reliably meet the power requirements for the receiver system's components. The system will supply 5 V to the receiver system's Arduino Nano ESP32 and 3.3 V to the ESP 8266 WiFi module.
...
The above schematic details the connections and voltages for the system. For this schematic the full pinout is not detailed for the Arduino Nano ESP32 and the ESP8266 WiFi module. The excluded details are not vital to the functionality of this subsystem. For the full schematic of these components refer to the datasheets provided in the references section. <br />
...
[3] "Climate and Average Weather Year Round in Cookeville," Weather Spark, https://weatherspark.com/y/15151/Average-Weather-in-Cookeville-Tennessee-United-States-Year-Round#:~:text=The%20length%20of%20the%20day,hours%2C%2037%20minutes%20of%20daylight.
