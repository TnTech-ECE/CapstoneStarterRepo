...
| 2   | Shall be able to send and receive at least 8-bit data reliably with the machine learning <br>subsystem through wireless signals| Design Constraint |
| 3   | Shall be able to send and receive at least 8-bit data from the main processor subsystem | Design Constraint | 
...
#### Encryption
The Arduino UNO WiFi Rev2 comes with the ATECC608 crypto chip accelerator [1][4]. It comes with hardware support for both symmetric and asymmetric encoding schemes <sup>6</sup>. After a full cycle, all data will be written over<sup>7</sup>.
