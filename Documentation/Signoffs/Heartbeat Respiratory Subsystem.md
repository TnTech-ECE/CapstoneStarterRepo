...
6.) In figure 3, it shows the simulation results of the operational amplifier circuit shown in figure 2 that must have a gain of 6. The input voltage of the operational amplifier circuit has an  amplitude of 0.4 V, and the output voltage of the operational amplifier circuit has an amplitude of 2.4 V. This allows the input voltage from the radar to be compatible with the analog to digital converter that will be attached to the computing subsystem. A thermal noise analysis was also conducted on this simulation. The thermal noise analysis has a range from 10 KHz to 100 GHz. As shown in figure 4, the thermal noise is around approximately 460 nV/Hz<sup>1/2</sup> from 10 KHz to approximately 900 GHz. Past 900 GHz, the thermal noise starts to drop where it starts to approach 0 nV/Hz<sup>1/2</sup> around 100 GHz.
